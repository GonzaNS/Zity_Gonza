// Sprint 13 · HU-HOME-01 — Vista dedicada a las solicitudes del residente.
// Ruta: /residente/solicitudes
//
// Contiene la funcionalidad que antes vivía en /residente (ResidenteDashboard):
//   • Lista completa de solicitudes con filtros
//   • Drawer de detalle (HU-MANT-05)
//   • Sección de pendientes de confirmación (HU-MANT-07)
//   • Modal de nueva solicitud
//
// La ruta /residente ahora es el dashboard integral con 3 tarjetas (HU-HOME-01).
...
export default function ResidenteSolicitudes() {
  const { user } = useAuth()
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="animate-fade-in flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div className="min-w-0">
            <Link
              to="/residente"
              className="text-sm text-warm-400 hover:text-primary-700 transition-colors"
            >
              ← Inicio
            </Link>
            <h1 className="font-display text-2xl sm:text-3xl font-semibold text-primary-900 tracking-tight mt-1">
              Mis solicitudes
            </h1>
          </div>
        ...
        <section className="mt-8 animate-fade-in delay-2">
          <h2 className="font-display text-lg sm:text-xl font-semibold text-primary-900 mb-4">
